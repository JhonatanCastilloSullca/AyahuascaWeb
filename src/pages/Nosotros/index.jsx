...
function NosotrosPage() {
    ...
    const { data: blogData, loading, error } = useFetch(`https://api.ayahuascamurayari.com/api/blogs?language_id=1&nosotros=0`, requestOptions);
                    ...
                    <Row className="mb-4">
                        <div className="d-flex flex-column justify-content-center align-items-center">
                            <p className="section-description w-100 p-3">
                                Si estás buscando un cambio profundo en tu vida, si sientes la llamada de la ayahuasca y deseas sanar tu corazón y tu alma, no dudes en unirte a uno de los retiros espirituales organizados por Alfonso Gutiérrez. Déjate guiar por su sabiduría y experiencia, y empieza tu camino hacia la sanación y la transformación en la selva amazónica de Iquitos, Peru.
                            </p>
                        </div>
                    </Row>
                    <Row>
