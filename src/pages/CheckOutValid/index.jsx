...
function CheckOutValid() {
    ...
    const { data, loading, error } = useFetch(`https://api.ayahuascamurayari.com/api/confirmar-pago?id=${id}`, requestOptions);
                    ...
                    <div className="login-box Booking-box">
                        <Card className="m-2">
                            <div className="d-grid justify-content-around w-100 m-auto p-2">
                                ...
                                <h4>Un agente de Ayahuasca Murayari se pondra en contacto con usted</h4>
                                <Card className="mt-4">
                                    <Card.Body>
