...
function ToursPage() {
    ...
    const { data: tourData, loading, error } = useFetch(`https://api.ayahuascamurayari.com/api/tour-slug?slug=${tourId}`, requestOptions);
                            ...
                            <div className="w-100">
                                ...
                                {tourData.recomendaciones && (
                                    <Container className="mt-4 ">
                                        <Accordion defaultActiveKey="0" className="p-0">
                                        <Accordion.Item eventKey="0">
                                            <Accordion.Header className="incluye-accordion">
                                            <h3 className="box-title border-0 mb-0">Qué Llevar</h3>
                                            </Accordion.Header>
                                            <Accordion.Body>
                                            <Row className="pt-4">
                                                <div
                                                className="description-tours recomendation-tours"
                                                dangerouslySetInnerHTML={{ __html: tourData.recomendaciones }}
                                                ></div>
                                            </Row>
                                            </Accordion.Body>
                                        </Accordion.Item>
