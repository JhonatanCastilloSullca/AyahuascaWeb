...
function ToursArchive() {
    ...
    const { data: GeneralData, loading: generalLoading, error: generalError } = useFetch("https://api.ayahuascamurayari.com/api/categorias", requestOptions);
    const { data: tourData, loading: tourLoading, error: tourError } = useFetch("https://api.ayahuascamurayari.com/api/tours", requestOptions);
