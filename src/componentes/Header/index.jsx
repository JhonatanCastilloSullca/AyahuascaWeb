                    ...
                    <nav className={navbar ? 'navbar active navbar-expand-lg' : 'navbar navbar-expand-lg'}>
                        <div className="container mw-100 px-5">
                            <Link to='/' className='navbar-logo'>
                                {navbar ? <img src="../assets/images/logo.webp" alt="logo-ayahuasca-murayari" className='logo-hor' /> : <img className='img-header-logo' src="../assets/images/logo.webp" alt="logo-ayahuasca-murayari" />}
                            </Link>
