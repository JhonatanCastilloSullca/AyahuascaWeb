...
function Header() {
    ...
    const { data, loading, error } = useFetch("https://api.ayahuascamurayari.com/api/categorias", requestOptions);
            ...
            <nav className={navbar ? 'navbar active navbar-expand-lg' : 'navbar navbar-expand-lg'}  >
                <div className="container">
                    <Link to='/' className='navbar-logo' >
                        {navbar ? <img src="../assets/images/vertigo-logo-horizontal-2.webp" alt="logo-ayahuasca-murayari" /> : <img className='img-header-logo' src="../assets/images/logo.webp" alt="logo-ayahuasca-murayari" />}
                    </Link>
